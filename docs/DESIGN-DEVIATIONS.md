...
| A4 الطلبات | ~~تابز بالمراحل~~ ✅ · بحث · فلاتر · تصدير CSV · تذييل بالترقيم ومتوسّط البقاء · ثلاث بطاقات شارحة |
| A5 العملاء | ~~تابز بالشرائح~~ ✅ · بطاقات المؤشّر الأربع بقيمها (متوسّط القيمة · متوسّط الصفقات · نسبة التوثيق · الاحتفاظ) · أعمدة الجدول كما في التصميم · الثلاث الشارحة |
...
## `MonitorTabs` — الشريط المشترك

مقيسٌ من ترميز A4 حرفيًّا: الشريحة `padding: 9px 15px` و`gap: 7px` وخطّها
`11px`، والعدّاد `padding: 1px 7px` بخطٍّ لاتينيّ `9.5px` لأنه رقم.
وتوكناتنا: `py-2.25 px-3.75` · `gap-1.75` · `text-3xs` · `font-num`.

**والصفر يُعرض ولا يُخفى**: تابٌ بصفر يقول «لا شيء هنا الآن»، وإخفاؤه
يجعل الشريط يتغيّر طوله بين زيارتين فيضيع موضع ما يبحث عنه المشغّل.

**ومكوّنٌ واحد لا اثنان.** بُني `FilterTabs` بالمقاسات الصحيحة ثم تبيّن
أن `MonitorTabs` قائمٌ ويخدم ستّ شاشات — فرُقّي القائم وحُذف الجديد،
فورثت الشاشات الثماني الشكلَ معًا: الطلبات · العملاء · كل الإعلانات ·
المزادات · العروض · التجار · سجلّ التدقيق · الأسئلة الشائعة.

### والتصميم يضع الشرائح على ٢٢ شاشة

مقيسٌ من الترميز: A4 · A5 · A6 · A7 · A8 · A9 · A15 · A16 · A17 · A18 ·
A21 · A22 · A23 · A24 · A25 · A26 · A27 · A28 · A31 · A33. ثمانٍ منها
تعمل، والبقيّة تحتاج عدّاداتها من النطاق.

### وعطلٌ كشفه المسح

**الأسئلة الشائعة كانت تعرض مفاتيح إنجليزية خامًا** — `inspection` و
`account` و`orders` و`negotiation` و`fees` في شريطٍ عربيّ. الخريطة خمس
والمزروع تسع، والسقوط إلى المفتاح (`?? row.category`) **لا يصرخ** فمرّ
النقص. أُكملت.
